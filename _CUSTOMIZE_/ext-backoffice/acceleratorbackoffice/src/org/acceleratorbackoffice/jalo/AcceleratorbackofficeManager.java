 ...
 */
package org.acceleratorbackoffice.jalo;
...
import org.acceleratorbackoffice.constants.AcceleratorbackofficeConstants;
 ...
 */
public class AcceleratorbackofficeManager extends GeneratedAcceleratorbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AcceleratorbackofficeManager.class.getName());
	 ...
	 */
	public static AcceleratorbackofficeManager getInstance()
	{
		return (AcceleratorbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AcceleratorbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AcceleratorbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AcceleratorbackofficeManager called.");
		}
	}
