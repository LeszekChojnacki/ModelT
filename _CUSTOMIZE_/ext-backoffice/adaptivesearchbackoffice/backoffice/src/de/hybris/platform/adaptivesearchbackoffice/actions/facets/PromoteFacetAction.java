...
public class PromoteFacetAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<AbstractEditorData, Object>
{
	...
	public ActionResult<Object> perform(final ActionContext<AbstractEditorData> ctx)
	{
		...
		if (facet instanceof AsFacetModel)
		{
			asConfigurationService.moveConfiguration(searchConfiguration, FACETS, PROMOTEDFACETS, facet.getUid());
		}
		else if (facet instanceof AsExcludedFacetModel)
		{
			asConfigurationService.moveConfiguration(searchConfiguration, EXCLUDEDFACETS, PROMOTEDFACETS, facet.getUid());
		}
		else
		{
	...
	public boolean canPerform(final ActionContext<AbstractEditorData> ctx)
	{
		...
		if (!(model instanceof AsFacetModel || model instanceof AsExcludedFacetModel))
		{
			return false;
		}
