...
/**
 * Filter which checks whether given {@link AttributeDescriptorModel} has is mandatory or not
 */
public class MandatoryCheckingFilter implements ExcelFilter<AttributeDescriptorModel>
{
	...
	{
		return !attributeDescriptorModel.getOptional() && !attributeDescriptorModel.getPrivate();
	}
