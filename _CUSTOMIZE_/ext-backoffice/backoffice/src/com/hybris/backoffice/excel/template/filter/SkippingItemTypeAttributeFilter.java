...
/**
 * Filter which checks whether given {@link AttributeDescriptorModel} is itemType property
 */
public class SkippingItemTypeAttributeFilter implements ExcelFilter<AttributeDescriptorModel>
{
	...
	{
		return !StringUtils.equals(ItemModel.ITEMTYPE, attributeDescriptorModel.getQualifier());
	}
}
