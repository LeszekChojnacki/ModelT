...
/**
 * Shows the sales units assigned to a sales unit employee
 */
public class DefaultOrgUnitEmployeeUnitsEditor extends DefaultEditorAreaPanelRenderer
{
			...
			final WidgetInstanceManager widgetInstanceManager)
	{
		if (object instanceof EmployeeModel)
		{
			...
			UITools.modifySClass(parentWrapper, "yw-editorarea-org-units-wrapper", true);
			...
			addtional.appendChild(new Label(Labels.getLabel("organization.sales.employee.units")));
