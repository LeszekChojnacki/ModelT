...
/**
 * Renderer for com.hybris.cockpitng.editor.simpleSelect.simpleselectlisteditor
 */
public class SimpleSelectListEditorRenderer<T> extends DefaultMultiReferenceEditor<T>
{
	...
	/**
	 * For customer.tickets attribute, unfortunately it return false always, that blocks creation field in bottom of the
	 * list Customer.addresses have same config, but method return true
	 *
	 * for feature use better figure out what is goind on in item.xml or somewhere else.
	 * 
	 * @return boolean
	 */
	@Override
