 ...
 */
public class CancelReturnAction extends AbstractComponentWidgetAdapterAware implements
		CockpitAction<ReturnRequestModel, ReturnRequestModel>
{
	...
	public boolean canPerform(final ActionContext<ReturnRequestModel> actionContext)
	{
		...
		if(data instanceof ReturnRequestModel)
		{
			...
			decision = returnStatus.equals(ReturnStatus.APPROVAL_PENDING)
					|| returnStatus.equals(ReturnStatus.APPROVING)
					|| returnStatus.equals(ReturnStatus.WAIT)
					|| returnStatus.equals(ReturnStatus.PAYMENT_REVERSAL_FAILED);
		}
		return decision;
	}
