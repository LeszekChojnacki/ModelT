...
public class ConditionsEditorViewModel extends AbstractEditorViewModel<String>
{
	...
	/**
	 *
	 * @deprecated since 6.6 use {@link #changeTreeNodeParameter(TreeNodeModel, String, Serializable) changeParameter} method
	 *             instead.
	 */
	@Deprecated
	@Command
	@NotifyChange(CONDITION_BREADCRUMBS)
	public void changeParameter(@BindingParam("treeNode") final TreeNodeModel<ConditionModel> treeNode,
			@BindingParam("parameterId") final String parameterId, @BindingParam("parameterValue") final Object parameterValue)
			throws EditorException
	{
		this.changeTreeNodeParameter(treeNode, parameterId, (Serializable) parameterValue);
	}
