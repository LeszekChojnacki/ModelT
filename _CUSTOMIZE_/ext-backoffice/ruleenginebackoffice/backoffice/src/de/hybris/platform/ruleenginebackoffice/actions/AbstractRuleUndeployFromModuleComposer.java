...
public abstract class AbstractRuleUndeployFromModuleComposer<I> extends AbstractRuleCompilePublishComposer
{
	 ...
	 *
	 * @param result
	 * @return true if undeployment failed otherwise false
	 * @deprecated since 6.6
	 */
	@Deprecated
	protected boolean hasErrors(final Optional<RuleCompilerPublisherResult> result)
	{
		return result.isPresent() && hasPublisherErrors(result.get());
	}
	...
	{
		return result.getPublisherResults().stream().anyMatch(RuleEngineActionResult::isActionFailed);
	}
