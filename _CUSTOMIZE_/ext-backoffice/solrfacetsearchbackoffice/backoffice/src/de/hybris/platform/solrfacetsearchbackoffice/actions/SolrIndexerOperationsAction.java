...
public class SolrIndexerOperationsAction extends AbstractComponentWidgetAdapterAware
		implements CockpitAction<SolrFacetSearchConfigModel, Object>
{
	...
	public ActionResult<Object> perform(final ActionContext<SolrFacetSearchConfigModel> ctx)
	{
		...
		parametersMap.put(ConfigurableFlowContextParameterNames.TYPE_CODE.getName(), "SolrIndexerOperationWizard");
