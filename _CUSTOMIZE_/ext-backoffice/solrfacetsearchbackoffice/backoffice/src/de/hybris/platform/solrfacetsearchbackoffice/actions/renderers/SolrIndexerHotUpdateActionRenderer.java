...
public class SolrIndexerHotUpdateActionRenderer extends DefaultActionRenderer<String, Object>
{
	protected static final String ACTION_NAME = "solrindexerhotupdate.action.name";
