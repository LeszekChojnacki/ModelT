...
/**
 * Prints a {@link ConsignmentModel#RETURNLABEL} for a {@link ConsignmentModel}.
 */
public class ConsignmentPrintReturnShippingLabelStrategy implements ConsignmentPrintDocumentStrategy
{
	...
	public void printDocument(final ConsignmentModel consignment)
	{
		...
		{
			returnShippingLabelMedia = getPrintMediaService().getMediaForTemplate(FRONTEND_TEMPLATENAME,
		...
		final String popup = getPrintMediaService()
				.generatePopupScriptForMedia(returnShippingLabelMedia, POPUP_WIDTH, POPUP_HEIGHT, resolveLabel(BLOCKED_POPUP_MESSAGE));
