...
/**
 * Default implementation of {@link AsBoostRulesMergeStrategy} for REPLACE merge mode.
 */
public class AsBoostRulesReplaceMergeStrategy extends AbstractAsBoostRulesMergeStrategy
{
	...
	protected <V extends AsBoostRule> void replace(final List<AsConfigurationHolder<V, AbstractAsBoostRuleConfiguration>> source,
