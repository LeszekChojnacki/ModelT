...
/**
 * Default implementation of {@link AsFacetsMergeStrategy} for ADD_AFTER merge mode.
 */
public class AsFacetsAddAfterMergeStrategy extends AbstractAsFacetsMergeStrategy
{
	...
	protected <V extends AbstractAsFacetConfiguration, C1 extends AbstractAsFacetConfiguration, C2 extends AbstractAsFacetConfiguration> void mergeAfter(
