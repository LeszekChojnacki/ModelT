 ...
 * 
 */
public interface ReplacementOrderProcessor
{
	/**
	 * Here you have the chance to handle your final Replacement order processing. For example for handling consignment
	 * creation
	 * 
	 * @param order
	 *           the order to be process
	 */
	void process(final ReplacementOrderModel order);
}
