...
public class CachedPromotionOrderAdjustTotalAction extends GeneratedCachedPromotionOrderAdjustTotalAction implements JaloOnlyItem // NOSONAR
{
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CachedPromotionOrderAdjustTotalAction newOne = (CachedPromotionOrderAdjustTotalAction) cl.newInstance();
	...
	protected AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(PromotionOrderAdjustTotalAction.class); // NOSONAR
			try //NOSONAR
			{
