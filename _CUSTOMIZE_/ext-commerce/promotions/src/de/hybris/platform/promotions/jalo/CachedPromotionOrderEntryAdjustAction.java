...
public class CachedPromotionOrderEntryAdjustAction extends GeneratedCachedPromotionOrderEntryAdjustAction implements JaloOnlyItem // NOSONAR
{
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CachedPromotionOrderEntryAdjustAction newOne = (CachedPromotionOrderEntryAdjustAction) cl.newInstance();
	...
	@Override
	public Product getOrderEntryProduct(final SessionContext ctx) // NOSONAR
	{
		return data.getProperty(ctx, ORDERENTRYPRODUCT);
	}

	@Override
	public void setOrderEntryProduct(final SessionContext ctx, final Product orderEntryProduct) // NOSONAR
	{
	...
	protected AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(PromotionOrderEntryAdjustAction.class);// NOSONAR
			try //NOSONAR
			{
