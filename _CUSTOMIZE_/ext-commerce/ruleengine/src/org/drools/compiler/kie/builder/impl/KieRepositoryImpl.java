...
//[y]added-start
import org.drools.core.common.LocalProperties;
//[y]added-end
...
//[y]removed		static final int MAX_SIZE_GA_CACHE // made changeable for test purposes
//[y]removed				= Integer.parseInt(System.getProperty(CACHE_GA_MAX_PROPERTY, "100"));

		public static final String CACHE_VERSIONS_MAX_PROPERTY = "kie.repository.project.versions.cache.size";
//[y]removed		static final int MAX_SIZE_GA_VERSIONS_CACHE // made changeable for test purposes
//[y]removed				= Integer.parseInt(System.getProperty(CACHE_VERSIONS_MAX_PROPERTY, "10"));
...
//[y]added-start
		...
		static
		{
			final Properties properties = LocalProperties.load();
			MAX_SIZE_GA_CACHE = Integer.parseInt(properties.getProperty(CACHE_GA_MAX_PROPERTY, "10"));
			MAX_SIZE_GA_VERSIONS_CACHE = Integer.parseInt(properties.getProperty(CACHE_VERSIONS_MAX_PROPERTY, "2"));
		}
//[y]added-end
