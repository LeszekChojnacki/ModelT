...
public class RuleEngineAllModulesInitJobPerformable extends AbstractRuleEngineJob
{
	...
	@Override
	protected Optional<RuleCompilerPublisherResult> performInternal(@SuppressWarnings("unused") final RuleEngineCronJobModel cronJob,
			final CronJobProgressTracker tracker)
	{
		setTrackerProgress(tracker,50d);
		final RuleCompilerPublisherResult result = getRuleMaintenanceService().initializeAllModules(true);
