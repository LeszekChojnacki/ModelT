...
/**
 * Implementation of the {@link de.hybris.platform.servicelayer.cronjob.JobPerformable} for modules syncronisation rule engine task
 */
public class RuleEngineModuleSyncJobPerformable extends AbstractRuleEngineJob
{
			...
			final CronJobProgressTracker tracker)
	{
		Optional<RuleCompilerPublisherResult> result = getRuleMaintenanceService()
				.synchronizeModules(cronJob.getSrcModuleName(), cronJob.getTargetModuleName());
