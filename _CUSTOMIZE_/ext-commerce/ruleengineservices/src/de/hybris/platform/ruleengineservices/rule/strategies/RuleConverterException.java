...
public class RuleConverterException extends RuleEngineServiceException
{
	...
	public RuleConverterException(final String message)
	{
		super(message);
	}

	public RuleConverterException(final Throwable cause)
	{
		super(cause);
	}

	public RuleConverterException(final String message, final Throwable cause)
	{
		super(message, cause);
	}
}
