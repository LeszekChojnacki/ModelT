...
public class DefaultSolrClientConfigCredentialsPopulator implements Populator<SolrServerConfigModel, SolrClientConfig>
{
	...
	{
		target.setUsername(ConfigurationUtils.getString(source, SolrServerConfigModel.USERNAME,
				SolrfacetsearchConstants.CLIENT_USERNAME_TEMPLATE, source.getName()));

		target.setPassword(ConfigurationUtils.getString(source, SolrServerConfigModel.PASSWORD,
				SolrfacetsearchConstants.CLIENT_PASSWORD_TEMPLATE, source.getName()));
	}
}
