...
public class IndexUpdateException extends Exception
{
	...
	public IndexUpdateException(final String message, final Throwable cause)
	{
		super(message, cause);
	}

	public IndexUpdateException(final String message)
	{
		super(message);
	}

	public IndexUpdateException(final Throwable cause)
	{
		super(cause);
	}
