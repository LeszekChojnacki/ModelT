...
public class FreeTextFuzzyQueryField implements Serializable
{
	...
	public FreeTextFuzzyQueryField(final String field)
	{
		this.field = field;
	}

	public FreeTextFuzzyQueryField(final String field, final Integer minTermLength, final Integer fuzziness, final Float boost)
	{
		this.field = field;
	...
	public void setFuzziness(final Integer fuzziness)
	{
		this.fuzziness = fuzziness;
	}
