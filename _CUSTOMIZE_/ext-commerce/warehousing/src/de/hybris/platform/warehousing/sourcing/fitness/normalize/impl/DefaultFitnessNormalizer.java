...
/**
 * Normalizes the fitness value by dividing it by the given total and multiplying by 100 to produce a percentage.</br>
 * <p>
 * Example</br> <tt>normalize(5.0, 20.0);</tt> means ((5.0 / 20.0) * 100) = 25
 * </p>
 */
public class DefaultFitnessNormalizer implements FitnessNormalizer
{
	...
	public Double normalize(final Double fitness, final Double total) throws IllegalArgumentException
	{
		...
		return (fitness / total) * ONE_HUNDRED;
	}
}
