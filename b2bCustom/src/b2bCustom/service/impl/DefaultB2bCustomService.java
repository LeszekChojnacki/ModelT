...
public class DefaultB2bCustomService implements B2bCustomService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultB2bCustomService.class);
	...
	{
		return DefaultB2bCustomService.class.getResourceAsStream("/b2bCustom/sap-hybris-platform.png");
	}
