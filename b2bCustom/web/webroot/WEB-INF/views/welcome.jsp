...
<html>
<head>
    <title>Welcome to b2bCustom</title>
    <link rel="stylesheet" href="<c:url value="/static/b2bCustom-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "b2bCustom" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/b2bCustom-items.xml</b> - here you can model your items</li>
            <li><b>resources/b2bCustom-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/b2bCustom-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/b2bCustom-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/b2bCustom-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
